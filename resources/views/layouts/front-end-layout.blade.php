...
<body class="font-sans antialiased">
    ...
    <div class="main-container">
        <div class="pd-ltr-20">
                    ...
                    <div class="col-md-8">
                        <h4 class="font-20 weight-500 mb-10 text-capitalize">
                            @foreach ($AboutText as $text)
                                ...
                                <div class="weight-600 font-30 text-blue"><span>Owner of the service : </span>
                                    {{ $text->about_text_header }}!
                                </div>
                        </h4>
            ...
            @livewire('best-selling-products-livewire')
            {{--  --}}
            <div class="footer-wrap pd-20 mb-20 card-box">
                <span>
                    &copy;copyright 2024 all rights reserved.
                </span>
                <span>Developed by Victor . Z . Kinyula</span>
            </div>
        </div>
    </div>
